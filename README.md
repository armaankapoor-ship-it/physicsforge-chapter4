# physicsforge-chapter4 - Moving Charges and Magnetism Visual Notes

A premium-style, zero-cost visual notes website for **NCERT Class 12 Physics Chapter 4: Moving Charges and Magnetism**.
...
Create a GitHub repository named `physicsforge-chapter4`, push this project, and use GitHub Pages from the `gh-pages` branch.

For a repository path build:

```bash
VITE_BASE_PATH=/physicsforge-chapter4/ pnpm build
```
